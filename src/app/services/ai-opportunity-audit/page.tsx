...
export const metadata: Metadata = {
  ...
  description:
    "A structured 2-hour assessment of your business operations, data, and team readiness. Walk away with a prioritised AI opportunity register — 3 to 5 use cases ranked by impact and effort.",
  openGraph: {
    title: "AI Opportunity Audit | ProjxAI",
    description:
      "Know exactly where AI fits in your business before spending a cent. Prioritised report delivered within 48 hours.",
    url: "https://www.projxai.com.au/services/ai-opportunity-audit",
...
const included = [
  ...
  "Written report delivered within 48 hours of the session",
  "Optional add-on: AI Tool Stack Review — audit tools you already pay for that have unused AI features",
];

const faqs = [
  {
    q: "Do I need to know anything about AI before the audit?",
    a: "No. The audit is designed to work regardless of where you're starting from. We ask questions about your business, not your technical knowledge.",
  },
  {
    q: "How long does it take?",
    a: "The working session is 2 hours. You receive your written report within 48 hours of the session.",
  },
  {
    q: "What if I already have some AI tools in place?",
    a: "That's useful context. Part of the audit looks at what you're already paying for and whether it's being fully used. Many businesses have AI features sitting idle in tools they already own.",
  },
  {
    q: "What happens after the audit?",
    a: "You receive a prioritised opportunity register. You can act on it independently, bring in your own team, or work with us on an AI Roadmap Sprint to turn it into a sequenced 90-day plan.",
  },
];
              ...
              {[
                {
                  ...
                  body: "We learn about your business and confirm the audit is the right starting point. You leave with 3 concrete insights regardless of whether we work together.",
                },
                {
                  step: "Audit Session (2 hours)",
                  body: "A structured working session — remote or in person. We map your operations, review your tools and data, and assess your team's readiness. You answer; we listen, ask, and document.",
                },
                {
                  step: "Written Report (within 48 hours)",
                  body: "3 to 5 prioritised AI opportunities, each with a potential impact assessment and implementation effort score. Written in plain English — no jargon, no padding.",
                },
                {
                  step: "Optional: Move to Roadmap Sprint",
        ...
        <div className="container">
          <div className="mx-auto max-w-[720px]">
            ...
            <ul className="space-y-2 text-base" style={{ color: "#494455" }}>
              <li>
                <Link href="/services/ai-roadmap-sprint" className="hover:underline" style={{ color: "#6B3FE7" }}>
